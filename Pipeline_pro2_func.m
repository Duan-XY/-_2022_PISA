function [Pipeline_tab, Pipeline_resource, Pipeline_rank, Pipeline, level_rely, num_TCAM, block_resource] = Pipeline_pro2_func(attachment1, n, dist_rely, level_rely)
