...
%% 0. read Input data
attachment1 = xlsread('./data/attachment11.csv');
attachment2 = readmatrix('./data/attachment22.csv','OutputType','string');
attachment3 = xlsread('./data/attachment33.csv');
...
%% 4. Resource -> Pipeline
% 4.1 Pro1
[Pipeline_tab_pro1, Pipeline_resource_pro1, Pipeline_rank_pro1, Pipeline_pro1, level_pro1, num_TCAM_pro1, block_resource] = Pipeline_pro1_func(attachment1, n, dist_rely, level_rely);
% 4.2 Pro2
